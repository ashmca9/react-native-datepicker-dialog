        ...
        <View style={styles.container} >
          <View style={styles.background}>
		    ...
		    locale={locale ? locale : 'en_EN'}
                  ...
                  />
                  <View style={{flexDirection: 'row'}}>
                    <TouchableHighlight style={{flex:1}} onPress={this.cancel.bind(this)} underlayColor={"#FFF"}>
                      <View style={{}}><Text style={styles.buttonTextStyle}>{this.props.cancelLabel}</Text></View>
                    </TouchableHighlight>
                    <TouchableHighlight style={{flex:1}} onPress={this.ok.bind(this)} underlayColor={"#FFF"}>
